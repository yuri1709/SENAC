...
<body>
    ...
    //2- Validar os dados
       ...
       //banco incremetado automacticamente, leva o null
            ...
            //a terceira camada(mysql) ja esta sendo validada com o not null.
            
            //4 abrir a conexao com banco de dados
            // servidor, usuario, senha , banco
            $con = mysqli_connect("localhost","root","","aula4"); //respon. pela conexao com o banco
            
            // gravar
            $result = mysqli_query($con,$sql); /*executa no banco e retorna um booleano porque o $sql é inserção()
            insert into cliente values(null,'".$nome."','".$email."','".$idade."','".$estado."')*/
            if($result){
